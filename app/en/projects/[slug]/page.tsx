      ...
      <main className="bg-white relative z-[1]">
        ...
        <div className="absolute right-10 pt-12 px-3 md:px-10 z-[10000]">
          <div className="flex-row right-0 gap-1 md:flex hidden">
            <Link href={`/en/projects/${project.slug.current}`} className="apercu-bold underline">EN</Link>
            /
            <Link href={`/de/projects/${project.slug.current}`} className="apercu-thin hover:underline">DE</Link>
          </div>
        </div>
