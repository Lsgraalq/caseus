...
export default async function ProjectsPageDE() {
  const projects = await sanityClient.fetch(PROJECTS_LIST_DE)
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {projects?.map((p: any) => (
          <ProjectCard
            ...
            href={`/de/projects/${p.slug}`}   // ✅ ведём на немецкую детальную
          />
        ))}
      </div>
    </main>
