 ...
 useEffect(() => {
  ...
  return (
    ...
    <nav className={`fixed top-0 left-0 w-full flex justify-center items-start z-50 text-black transition-transform duration-550  ${
      ...
      <div className="relative flex flex-row  mt-8 ml-5 pl-5 pr-5 pt-2 pb-2 border-white/20 border rounded-2xl  items-center gap-8 glassnav" ref={navbarRef}>
        {/* Круг */}
        {/* <div
           ref={circleRef}
          className=" w-12 h-12 bg-gray-600 rounded-full  text-black text-xl font-bold z-20"
        >
